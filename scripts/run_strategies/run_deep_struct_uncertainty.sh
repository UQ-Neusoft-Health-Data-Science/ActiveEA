...
data_variant=DEEP_STRUCT_UNCER_alpha${alpha}_batchsize${sample_num_per_ite}_dropout${dropout_ratio}
...
# special setting
. $proj_dir/scripts/modules/run_strategy_deep_struct_uncertainty.sh
