...
from openea.modules.finding.evaluation import valid, test, early_stop, test_exp
...
class BasicModel:
    ...
    def test(self, save=True):
        ...
        rest_12, hits_12, mr_12, mrr_12, ndcgs = test_exp(embeds1, embeds2, mapping, self.args.top_k, self.args.test_threads_num,
        ...
        # _, hits_12, mr_12, mrr_12, ndcgs = test_exp(embeds1, embeds2, mapping, self.args.top_k, self.args.test_threads_num,
    ...
    def restore(self):
        ...
        if not os.path.exists(model_fn+".meta"):
            ...
            return
        saver = tf.compat.v1.train.Saver()
        saver.restore(self.session, model_fn)
